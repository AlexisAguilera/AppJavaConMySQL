...
import Inspector.InspectorGUI;
import Parquimetros.ParquimetrosGUI;
...
public class VentanaPrincipal extends javax.swing.JFrame 
{
   ...
   private JMenuItem mniParquimetros;
   private JMenuItem mniInspectores;
...
/*
   ...
   private void initGUI() 
   {
      ...
      try {
         {
            this.setTitle("Sistema de administración y control de estacionamientos");
         ...
         }
         {
            ...
            dlgAcercaDe.setUndecorated(true);
            {
               ...
               lblAcercaDe1.setText("Implementacion de un sistema con base de datos");
            ...
            }
            {
               ...
               lblAcercaDe2.setText("Proyecto N°3");
               lblAcercaDe2.setHorizontalAlignment(SwingConstants.CENTER);
            }
            {
               lblAcercaDe3 = new JLabel();
               lblAcercaDe3.setText("<html><center>Integrantes:<br/>Ignacio del Barrio (LU:97396)<br/>Alexis Aguilera (LU:100723)<br/>");
         ...
         }
         {
            ...
            setJMenuBar(jMenuBar1);
            {
               ...
               mnuEjemplos.setText("Ejemplos");
               {
                  ...
                  mniAdmin.setText("Administrador");
                  mniAdmin.addActionListener(new ActionListener() {
                     public void actionPerformed(ActionEvent evt) {
                        //mniAdminActionPerformed(evt);
                    	 jDesktopPane1.add(new AdminGUI().ventana);
                     }
                  });
               }
               {
                  mniInspectores = new JMenuItem();
                  mnuEjemplos.add(mniInspectores);
                  mniInspectores.setText("Inspector");
                  mniInspectores.addActionListener(new ActionListener() {
                     public void actionPerformed(ActionEvent evt) {
                        //mniInspectoresActionPerformed(evt);
                    	 jDesktopPane1.add(new InspectorGUI().ventana);
                     }
                  });
               }
               {
                   mniParquimetros = new JMenuItem();
                   mnuEjemplos.add(mniParquimetros);
                   mniParquimetros.setText("Parquimetros");
                   mniParquimetros.addActionListener(new ActionListener() {
                      public void actionPerformed(ActionEvent evt) {
                         //mniParquimetrosActionPerformed(evt);
                     	 jDesktopPane1.add(new ParquimetrosGUI().ventana);
                      }
                   });
                }
               {
   ...
   {/*
      ...
      */
	   this.jDesktopPane1.add(new AdminGUI().ventana);
   }
   
   private void mniParquimetrosActionPerformed(ActionEvent evt) 
   {/*
      try
      {
   ...
   private void mniInspectoresActionPerformed(ActionEvent evt) 
   {/*
      try
      {

...
/**
 * Panel de login del inspector.
 * Es uno de los paneles de InspectorGUI.
 * @see InspectorGUI
 */
public class InspectorLoginPanel extends JPanel {
...
//Constructores
	 ...
	 */
	public InspectorLoginPanel(InspectorGUI manejador){
		super();
		...
		JLabel titulo = new JLabel("Inspector Login");
		...
		JLabel lblNewLabel = new JLabel("Ingrese PSW:");
